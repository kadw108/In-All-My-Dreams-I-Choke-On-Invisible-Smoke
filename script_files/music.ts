...
/*
note: some sites don't seem to support mp3s. it will act like they're support but they'll load infinitely. idk why
...
const dreamMusicA: Array<Howl> = [
    addMaxVolume(
        new Howl({
            src: ["assets/music/deuteronomy_-_evaporation_-_02_starboarding_ura_(w-_Darius).ogg", "assets/music/deuteronomy_-_evaporation_-_02_starboarding_ura_(w-_Darius).mp3"],
            loop: true,
    ...
    addMaxVolume(
        new Howl({
            src: ["assets/music/gusts_of_wind.ogg", "assets/music/gusts_of_wind.mp3"],
            loop: true,
    ...
    addMaxVolume(
        new Howl({
            src: ["assets/music/birds_noises.ogg", "assets/music/birds_noises.mp3"],
            loop: true,
...
const mixMusic: Array<Howl> = [
    ...
    addMaxVolume(
        new Howl({
            src: ["assets/music/deuteronomy_-_evaporation_-_01_establishing_shot_ura.ogg", "assets/music/deuteronomy_-_evaporation_-_01_establishing_shot_ura.mp3"],
            loop: true,
...
const musicEnd1: Array<Howl> = [
    addMaxVolume(
        new Howl({
            src: ["assets/music/deuteronomy_-_winter,_again,_soon_(vignettes)_-_03_empty_home_on_the_escarpment.ogg", "assets/music/deuteronomy_-_winter,_again,_soon_(vignettes)_-_03_empty_home_on_the_escarpment.mp3"],
            loop: true,
...
const musicMenu: Array<Howl> = [
    addMaxVolume(
        new Howl({
            src: ["assets/music/glitchOST_Enchanted_Woods.ogg", "assets/music/glitchOST_Enchanted_Woods.mp3"],
            loop: true,
